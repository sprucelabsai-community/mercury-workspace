...
export type ExtractListenerPayload<Payload extends ISchema | MercuryPagedResponse> = Payload extends ISchema ? ISchema : MercuryPagedResponse['payload']

export default interface MercuryClient<C extends MercuryContract> {
    on<
        EventNamespace extends string, 
        EventName extends string, 
        EmitPayload extends SchemaValues<C[EventNamespace][EventName]['emitPayload']>, 
        ListenResponsePayload extends SchemaValues<ExtractListenerPayload<C[EventNamespace][EventName]['listenResponsePayload']>>
    >(
        eventNamespace: EventNamespace, 
        eventName: EventName, 
        cb?: (payload: EmitPayload) => ListenResponsePayload | Promise<ListenResponsePayload>
    ): Promise<void>
