...
export const DEMO_PHONE_PROXY =
	process.env.DEMO_PHONE_PROXY ?? DEMO_PHONE_TEAMMATE
export const DEMO_PHONE_FLATTEN_1 =
	process.env.DEMO_PHONE_FLATTEN_1 ?? DEMO_PHONE_TEAMMATE
export const DEMO_PHONE_FLATTEN_2 =
	process.env.DEMO_PHONE_FLATTEN_2 ?? DEMO_PHONE_TEAMMATE
